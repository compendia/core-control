...
wrong_arguments() {
  ...
  echo -e "| install  | core advanced                       | Install Core (without UFW)         |"
  ...
  echo -e "| start    | relay / forger / core / all         | Start Core Services                |"
  echo -e "| restart  | relay / forger / core / all / safe  | Restart Core Services              |"
  echo -e "| stop     | relay / forger / core / all         | Stop Core Services                 |"
  echo -e "| status   | relay / forger / core / all         | Show Core Services Status          |"
  echo -e "| logs     | relay / forger / core / all         | Show Core Logs                     |"
...
install_deps() {
  ...
  sudo npm install n -g >/dev/null 2>&1
  sudo npm install grunt-cli -g >/dev/null 2>&1
  sudo npm install pm2 -g >/dev/null 2>&1
  sudo npm install yarn -g >/dev/null 2>&1
  sudo npm install lerna -g >/dev/null 2>&1
